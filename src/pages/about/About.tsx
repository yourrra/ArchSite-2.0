    ...
    <div className={styles.About}>
      <div className={styles.InfoBlock}>
        ...
        <div className={styles.Text}>
          ...
          <TextBlock>
            Over the years, I have gained unique experience, which allows me to
            find efficient solutions for any architectural task, whether it's a
            large master plan or a simple house in the woods.
          </TextBlock>
        </div>
      </div>
